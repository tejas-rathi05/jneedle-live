      ...
      <div className="flex flex-row items-center gap-2">
        ...
        <div className="flex flex-col">
          <div className="w-full h-full flex">
            <span className="w-git h-fit text-4xl">"</span>
            <blockquote
              className={cn(
                "mt-2 text-xl text-center bg-blue-100",
                delicious_handrawn.className
              )}
            >
              {body}
            </blockquote>
            <span className="text-4xl h-fit w-fit bottom-0">"</span>
          </div>
...
const ReviewMarquee = () => {
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-lg border bg-background py-20 md:shadow-xl">
      ...
      <h4 className="text-5xl font-extrabold tracking-wider text-center py-10 mb-10 text-stone-800">
        CUSTOMER REVIEWS
      </h4>
